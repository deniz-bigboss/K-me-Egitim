...
(function () {
  ...
  var INTENTS = [
    ...
    { a: 2, keys: ['kayit', 'kaydol', 'on kayit', 'basvur', 'kayit ol', 'nasil kayit', 'kayit yaptir', 'nasil katil'],
    ...
    { keys: ['adres', 'konum', 'nerede', 'neresi', 'nasil gelir', 'nasil gel', 'yol tarifi', 'harita', 'sube', 'lokasyon', 'nerda', 'hangi semt', 'hangi semtte'],
    ...
    { keys: ['saat', 'calisma saat', 'acik', 'kacta', 'ne zaman acik', 'mesai', 'kacta aciliyor', 'hafta sonu', 'cumartesi', 'pazar', 'calisiyor mu', 'kacta kapan'],
    ...
    { keys: ['basari', 'derece', 'sonuc', 'siralama', 'yorum', 'gorus', 'referans', 'kac kisi kazandi', 'kazandi', 'kazanan', 'universite kazan', 'hangi universite'],
    ...
    { a: 2, keys: ['ogretmen', 'ogretmenler', 'ogretmenleriniz', 'kadro', 'egitim kadrosu', 'hoca', 'hocalar', 'egitmen', 'kimler ders veriyor', 'brans'],
      answer: 'Alanında uzman, deneyimli bir eğitim kadromuz var. Öğretmenlerimizi branşlarıyla birlikte Hakkımızda sayfamızdaki <b>Eğitim Kadromuz</b> bölümünde görebilirsiniz:',
      actions: [['Eğitim Kadromuz', 'hakkimizda.html#kadro']] },
    { a: 2, keys: ['haber', 'haberler', 'duyuru', 'duyurular', 'guncel', 'yenilik', 'son gelismeler', 'etkinlik'],
      answer: 'Güncel duyuru ve haberlerimizi (kayıt dönemleri, deneme sınavı takvimi, etkinlikler) Haberler sayfamızdan takip edebilirsiniz:',
      actions: [['Haberler ve Duyurular', 'haberler.html']] },
    { keys: ['sss', 'sik sorulan', 'sikca sorulan', 'sikca', 'sorulan sorular', 'merak', 'soru sor', 'sorum var'],
